...
from multimodal_comms.apps.collab_overcooked.overcooked_ai_py.agents.agent import GreedyHumanModel, StayAgent, RandomAgent
from multimodal_comms.apps.collab_overcooked.overcooked_ai_py.agents.agent import AgentFromPolicy, AgentPair
...
from multimodal_comms.apps.collab_overcooked.overcooked_ai_py.utils import load_dict_from_file, load_pickle


from multimodal_comms.apps.collab_overcooked.collab.collab import LLMAgents

from collections import defaultdict
from multimodal_comms.apps.collab_overcooked.collab.modules import EMBEDDING_MODEL
from multimodal_comms.apps.collab_overcooked.settings import require_openai_key
...
def get_example_embedding(example_path, save_path=""):
    ...
    # save embedding
    if save_path == "":
        save_path = "embedding_" + ("chef" if "chef" in example_path else "assistant") + ".csv"
