try:
    ...
    class _GymUnavailable:
        class Env:
            pass

        @property
        def spaces(self):
            raise RuntimeError("the Gym wrapper requires the full Conda environment")

    gym = _GymUnavailable()
import tqdm
import numpy as np
from multimodal_comms.apps.collab_overcooked.overcooked_ai_py.utils import mean_and_std_err
