...
class LLaMA32Agent(Agent):
    ...
    def respond(self, input_data, actions):
        ...
        output = self.model.generate(**inputs, max_new_tokens=self.config.get("max_output_len", 1024), temperature=0.01)
