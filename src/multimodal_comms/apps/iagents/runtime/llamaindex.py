...
from multimodal_comms.apps.iagents.backend.third_party_embedding import *
from multimodal_comms.apps.iagents.backend.gpt import *
...
class LlamaIndexer():
    ...
    def __init__(self, username) -> None:
        if global_config.get("backend").get("provider") == "ollama":
            from multimodal_comms.apps.iagents.backend.ollama import ollama_model, ollama_embed_model
