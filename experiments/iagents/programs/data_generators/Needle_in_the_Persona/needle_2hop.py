...
from multimodal_comms.apps.iagents.backend.gpt import query_gpt4


# Constants
NUM_SAMPLES = 28  # pool for compression-sweep harvest+eval split
DATASET_PATH = "google/Synthetic-Persona-Chat"
OUTPUT_FILE = "./dataset_2hop_pool.jsonl"
